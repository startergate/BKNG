...
<html>
  ...
  <body>
    <div class="container-fluid" id='padding-erase'>
      <div id="bgi">
        <div class="col-md-3">
          <a href="./.php" class='btn btn-link middle' id='white margin-erase'><h3>BKNG</h3></a>
        </div>
        <div class="col-md-9">
          <div class="text-right">
            <a href='./admin-logout.php' class='btn btn-link' id='white'>로그아웃</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <ol class="nav" nav-stacked="" nav-pills="">
          <?php
            while ($row = mysqli_fetch_assoc($result)) {
              echo '<li><a href="./note.php?id='.$row['name'].'">'.$row["value"],'</li></a>'."\n";
            }
          ?>
