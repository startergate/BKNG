...
<html>
  ...
  <body id="bge">
    <div class="covra2">
      <div id=login>DATA INSERT</div>
      <br />
      <div id=lotext>
        <br />
        <h3><strong>HASH GENERATE</strong></h3>
        <br />
        <form id='form' action="./hash_gen.php" method="post">
          <input type="password" class="form-control" name="text" id="form-title" placeholder="비밀번호">
          <br />
          <input type="submit" name="confirm_register" class="btn btn-light" value='전송'>
